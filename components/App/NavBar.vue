        ...
        <div class="flex items-center justify-between">
            ...
            <div class="hidden md:block dark:text-white">
                <ul class="flex items-center space-x-8 text-sm font-sans">
                    ...
                    <li>
                        <a href="#" class="cta bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded text-white font-semibold">
                            Sign Up
                        </a>
                    </li>
                </ul>
            ...
            <!-- Drawer Menu -->
            <aside
                class="dark:bg-themeBackground dark:text-white p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30"
